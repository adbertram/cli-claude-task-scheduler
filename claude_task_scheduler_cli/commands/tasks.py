...
def create_task(
    ...
    summary_model: str = typer.Option("opus", "--summary-model", help="Model for generating run summaries (default: opus)"),
...
def update_task(
    ...
    summary_model: Optional[str] = typer.Option(None, "--summary-model", help="Model for generating run summaries"),
